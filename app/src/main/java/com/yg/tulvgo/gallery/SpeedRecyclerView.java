 ...
 */
public class SpeedRecyclerView extends CustomRecyclerView {
    private static final float FLING_SCALE_DOWN_FACTOR = 0.3f; // 减速因子
    private static final int FLING_MAX_VELOCITY = 9900; // 最大顺时滑动速度
