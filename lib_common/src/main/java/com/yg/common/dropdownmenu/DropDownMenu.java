package com.yg.common.dropdownmenu;
...
public class DropDownMenu extends LinearLayout {
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        dividerColor = a.getColor(R.styleable.DropDownMenu_dddividerColor,dividerColor);//dividerColor
...
//        underLine.setBackgroundColor(underlineColor);
        underLine.setBackgroundResource(R.drawable.line);
        addView(underLine, 1);
...
//                    ((TextView) tabMenuView.getChildAt(i)).setTextColor(textSelectedColor);
                    ((TextView) tabMenuView.getChildAt(i)).setTextColor(this.getResources().getColor(R.color.color_ffb15a));
